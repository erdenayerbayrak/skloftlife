  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="container py-4 px-4 marble-hero-content">
      ...
      {/* Process Section - Cream Marble Background */}
      <section className="py-24 relative cream-marble-background">
